<?php
class Staple_Form_FoundationPasswordElement extends Staple_Form_Element
{
	/**
	...
	public function field()
	{
		...
		return '	<input type="password" id="'.$this->escape($this->id).'" name="'.$this->escape($this->name).'" value="'.$this->escape($this->value).'"'.$size.$max.$this->getAttribString().'>'."\n";
	}
	...
	{
		$buf = '';
		$view = FORMS_ROOT.'/fields/FoundationPasswordElement.phtml';
		if(file_exists($view))
		{
			ob_start();
			include $view;

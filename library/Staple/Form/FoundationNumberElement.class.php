<?php
class Staple_Form_FoundationNumberElement extends Staple_Form_Element
{
	/**
	...
	public function field()
	{
		...
		return '	<input type="number" id="'.$this->escape($this->id).'" name="'.$this->escape($this->name).'" value="'.$this->escape($this->value).'"'.$classes.$size.$max.$this->getAttribString().'>'."\n";
	}

<?php
class Staple_Form_FoundationTextElement extends Staple_Form_Element
{
	/**
	...
	public function field()
	{
		...
		return '	<input type="text" id="'.$this->escape($this->id).'" name="'.$this->escape($this->name).'" value="'.$this->escape($this->value).'"'.$classes.$size.$max.$this->getAttribString().'>'."\n";
	}
	...
	{
		$buf = '';
		$view = FORMS_ROOT.'/fields/FoundationTextElement.phtml';
		if(file_exists($view))
		{
			ob_start();
			include $view;

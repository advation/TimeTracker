<?php
class Staple_Form_FoundationTextareaElement extends Staple_Form_Element
{
	/**
	...
	public function field()
	{
		...
		return '	<textarea id="'.$this->escape($this->id).'" name="'.$this->escape($this->name).'" '.$this->getAttribString().' '.$classes.' >'.$this->escape($this->value).'</textarea>'."\n";
	}
	...
	{
		$buf = '';
		$view = FORMS_ROOT.'/fields/FoundationTextareaElement.phtml';
		if(file_exists($view))
		{
			ob_start();
			include $view;
